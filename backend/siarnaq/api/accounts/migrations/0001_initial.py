    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('W', 'Woman'), ('M', 'Man'), ('N', 'Non Binary'), ('*', 'Custom'), ('?', 'Rather Not Say')], max_length=1)),
                ('gender_details', models.CharField(blank=True, max_length=32)),
                ('school', models.CharField(blank=True, max_length=128)),
                ('biography', models.TextField(blank=True, max_length=1024)),
                ('kerberos', models.SlugField(blank=True, max_length=16)),
