    ...
    if (this.state.ide === "intellij") {
        ...
        <div>
          <ul style={{ marginLeft: "-15px" }}>
            <li>
              ...
              <b>
                <a href="https://www.jetbrains.com/idea/download/">from here</a>
              </b>
              .
            </li>

            <li>
              In the <code>Welcome to IntelliJ IDEA</code> window that pops up
              when you start IntelliJ, select <code>Import Project</code>
            </li>

            <li>
              In the <code>Select File or Dictionary to Import</code> window,
              select the <code>build.gradle</code> file in the scaffold folder.
            </li>

            <li>Hit OK.</li>

            <li>
              We need to set the jdk properly; open the settings with{" "}
        ...
        <div>
          <ul style={{ marginLeft: "-15px" }}>
            <li>
              ...
              <b>
                <a href="https://www.eclipse.org/downloads/">from here</a>
              </b>
              .
            </li>
            ...
            <li>
              Run <code>File -{">"} Import...</code>, and select{" "}
              <code>Gradle / Existing Gradle Project</code>.
              <Floater
                content={
                  <div>
                    <p>
                      If you are unable to find this option, you may be using an
                      old version of Eclipse. If updating your Eclipse version
                      still does not work, you may need to manually install the
                      "Buildship" plugin from the Eclipse marketplace.
                    </p>
                  </div>
                }
            ...
            <li>
              If you do not see a window labeled <code>Gradle Tasks</code>,
              navigate to <code>Window / Show View / Other...</code>. Select{" "}
              <code>Gradle / Gradle Tasks</code>.
            </li>
            ...
            <li>
              ...
              the client and other resources.
            </li>

            <li>
              You're good to go; you can run other Gradle tasks using the other
              options in the <code>Gradle Tasks</code> menu. Note that you
              shouldn't need any task not in the <code>battlecode</code> group.
              <Floater
                content={
                  <div>
                    <p>
                      If you rename or add jar files to the lib directory,
                      Eclipse gets confused. You'll need to re-add them using{" "}
                      <code>Project / Properties / Java Build Path</code>.
                    </p>
                  </div>
                }
                showCloseButton={true}
      ...
      return (
        <div>
          <ul style={{ marginLeft: "-15px" }}>
            <li>
              Start every Gradle command with <code>./gradlew</code>, if using
              Mac or Linux, or <code>gradlew</code>, if using Windows.
            </li>

            <li>
              You will need to set the <code>JAVA_HOME</code> environment
              variable to point to the installation path of your JDK.
              <Floater
                content={
                  <div>
                    <p>
                      On Mac, <code>JAVA_HOME</code> should probably be
                      something like{" "}
                      <code>
                    ...
                    <p>
                      ...
                      <code>C:\Program Files\Java\jdk1.8.0_271</code>.
                    </p>
                  </div>
                }
                showCloseButton={true}
            ...
            <li>
              You're good to go. Run <code>./gradlew -q tasks</code> (
              <code>gradlew -q tasks</code> on Windows) to see the other Gradle
              tasks available. You shouldn't need to use any tasks outside of
              the <code>battlecode</code> group.
            </li>
          </ul>
        </div>
      );
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className="card">
                ...
                <div className="content">
                  <p>
                    To participate in Battlecode, you need an account and a
                    team. Each team can consist of 1 to 4 people.
                  </p>
                  <p>
                    <NavLink to={`/register`} style={{ fontWeight: 700 }}>
                      Create an account
                    </NavLink>{" "}
                    on this website, and then go to the{" "}
                    <NavLink
              ...
              <div className="card">
                ...
                <div className="content">
                  ...
                  <p>
                    ...
                    <Floater
                      content={
                        <div>
                          <p>
                            Alternatively, you can install a JDK yourself using
                            your favorite package manager. Make sure it's an
                            Oracle JDK — we don't support anything else — and is
                  ...
                  <p></p>
                  <p>
                    If you're unsure how to install the JDK, you can find
              ...
              <div className="card">
                ...
                <div className="content">
                  <p>
                    Battlecode has a Discord server! Everyone is encouraged to
                    join. Announcements, strategy discussions, bug fixes and
                    ~memes~ all happen on Discord. Follow this invite link to
                    join:{" "}
                    <a
                      href="https://discord.gg/N86mxkH"
                      style={{ fontWeight: 700 }}
                    >
                      https://discord.gg/N86mxkH
                    </a>
                    .
                  </p>
                </div>
