...
const bcVersions: Record<string, typeof BC24 | typeof BC23 | typeof BC22 | typeof BC24TEST> = {
  bc24: BC24,
  bc23: BC23,
  bc22: BC22,
  bc24test: BC24TEST
...
function createTextRecord<K extends PageKey>(key: string): Record<string, Partial<Record<K, string>>> {
...
export const debuggingTipsText = createTextRecord<DebuggingTipsPageKey>('DEBUGGINGTIPS');
export const commonIssuesText = createTextRecord<CommonIssuesPageKey>('COMMONISSUES');